...
forestbivar<-function(studlab,TP,FP,FN,TN,sdSens,sdSpec,
	...
	predSensPE=NULL,predSensCI=NULL,predSpecPE=NULL,predSpecCI=NULL,
    ...
    axes = "black", background = NA) 
{
	...
	if(!is.null(predSensPE)) predlab="Predictive effect" else predlab=""

	tabletext<-cbind(c("Study",NA,studlab,NA,"Pooled effect",predlab),
                 c("TP",NA,TP,NA,NA,NA),#you can change the order of these
                 c("FP",NA,FP,NA,NA,NA),
                 c("FN",NA,FN,NA,NA,NA),
                 c("TN",NA,TN,NA,NA,NA),
                 c("Sensitivity",NA,
	...
	m.sens<- c(NA,NA,sensPE,NA,pooledSensPE,predSensPE)
	l.sens<- c(NA,NA,sensCI[,1],NA,pooledSensCI[1],predSensCI[1])
	u.sens<- c(NA,NA,sensCI[,2],NA,pooledSensCI[2],predSensCI[2])

	m.spec<- c(NA,NA,specPE,NA,pooledSpecPE,predSpecPE)
	l.spec<- c(NA,NA,specCI[,1],NA,pooledSpecCI[1],predSpecCI[1])
	u.spec<- c(NA,NA,specCI[,2],NA,pooledSpecCI[2],predSpecCI[2])
